 ...
 *
 */
public class SendRabbitMqMessageException extends RuntimeException {
	...
	public SendRabbitMqMessageException(BaseDTO baseDTO, ErrorsEnum errorsEnum, Exception e) {
		super(e);
		this.baseDTO = baseDTO;
		this.errorsEnum = errorsEnum;
	}

	public SendRabbitMqMessageException(BaseDTO baseDTO, ErrorsEnum errorsEnum) {
		this.baseDTO = baseDTO;
		this.errorsEnum = errorsEnum;
	}
